...
loader = DirectoryLoader(path="data_ anticoagulant", glob='**/*.pdf', loader_cls=PyMuPDFLoader)
...
system_prompt = SystemMessage(content=
    """You are an assistant for question-answering tasks for medical professionals. 
